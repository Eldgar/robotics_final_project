...
class Metaclass_AlignBarista_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('barista_alignment')
        except ImportError:
            import logging
            import traceback
...
class AlignBarista_SendGoal_Request(metaclass=Metaclass_AlignBarista_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'barista_alignment/AlignBarista_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['barista_alignment', 'action'], 'AlignBarista_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from barista_alignment.action._align_barista import AlignBarista_Goal
...
class Metaclass_AlignBarista_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'barista_alignment.action.AlignBarista_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from barista_alignment.action import _align_barista
...
class AlignBarista_SendGoal(metaclass=Metaclass_AlignBarista_SendGoal):
    from barista_alignment.action._align_barista import AlignBarista_SendGoal_Request as Request
    from barista_alignment.action._align_barista import AlignBarista_SendGoal_Response as Response
...
class AlignBarista_GetResult_Response(metaclass=Metaclass_AlignBarista_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'barista_alignment/AlignBarista_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['barista_alignment', 'action'], 'AlignBarista_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from barista_alignment.action._align_barista import AlignBarista_Result
...
class Metaclass_AlignBarista_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'barista_alignment.action.AlignBarista_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class AlignBarista_GetResult(metaclass=Metaclass_AlignBarista_GetResult):
    from barista_alignment.action._align_barista import AlignBarista_GetResult_Request as Request
    from barista_alignment.action._align_barista import AlignBarista_GetResult_Response as Response
...
class Metaclass_AlignBarista_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'barista_alignment.action.AlignBarista_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class AlignBarista_FeedbackMessage(metaclass=Metaclass_AlignBarista_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'barista_alignment/AlignBarista_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['barista_alignment', 'action'], 'AlignBarista_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from barista_alignment.action._align_barista import AlignBarista_Feedback
...
class Metaclass_AlignBarista(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'barista_alignment.action.AlignBarista')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class AlignBarista(metaclass=Metaclass_AlignBarista):
    ...
    from barista_alignment.action._align_barista import AlignBarista_Goal as Goal
    # The result message defined in the action definition.
    from barista_alignment.action._align_barista import AlignBarista_Result as Result
    # The feedback message defined in the action definition.
    from barista_alignment.action._align_barista import AlignBarista_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from barista_alignment.action._align_barista import AlignBarista_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from barista_alignment.action._align_barista import AlignBarista_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from barista_alignment.action._align_barista import AlignBarista_FeedbackMessage as FeedbackMessage
