...
: ${AMENT_CURRENT_PREFIX:="/home/user/ros2_ws/install/main_navigation"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/main_navigation/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/main_navigation/environment/path.sh"
